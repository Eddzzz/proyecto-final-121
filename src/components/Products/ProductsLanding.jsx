          ...
          <div className="row">
            <div className="container py-5 mb-0">
              ...
              >
                ...
                <h1 className="mb-5">Las Delicias más Populares</h1>
              </div>
                ...
                <ul className="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5">
                  ...
                  <li className="nav-item">
                    ...
                    >
                      ...
                      />
                      <div className="ps-3">
                        <small className="text-dark">Especial</small>
                        <h6 className="mt-n1 mb-0 text-dark fw-bold">Almuerzo</h6>
                      </div>
                    </a>
                  </li>
                  <li className="nav-item">
                    ...
                    >
                      ...
                      <div className="ps-3">
                        ...
                        <h6 className="mt-n1 mb-0 fw-bold text-dark">Cena</h6>
                      </div>
                    </a>
                  </li>
                </ul>
